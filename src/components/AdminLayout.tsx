...
export default function AdminLayout({
  ...
  return (
    <div className="font-popppins">
      ...
      <div className="sm:mt-[50px] min-h-[100vh] sm:ml-[200px] 2xl:ml-[250px] bg-[#edeff2] py-10 sm:px-[30px] md:px-[50px] lg:pr-0 md:grid lg:grid-cols-[_1fr_400px] 2xl:grid-cols-[_1fr,_450px] relative z-0 ">
