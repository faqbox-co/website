...
export default function AdminLayout({
  ...
  return (
    <div className="font-popppins">
      ...
      <div className="min-h-[100vh] sm:ml-[200px] 2xl:ml-[250px] bg-[#edeff2] py-10 sm:px-[30px] md:px-[50px] lg:pr-0 md:grid lg:grid-cols-[_1fr_400px] 2xl:grid-cols-[_1fr,_1fr] relative z-0 ">
        ...
        {children}
        <div className="lg:flex flex-col hidden h-fit sticky top-20 z-10">
          <h1 className="text-center text-lg font-semibold mb-3">Preview</h1>
          <div className="bg-slate-950 rounded-3xl w-[270px] 2xl:w-[380px] h-[551.25px] 2xl:h-[773.75px] flex mx-auto">
            <div className="w-[250px] 2xl:w-[350px] h-[531.25px] 2xl:h-[743.75px] rounded-2xl m-auto font-semibold  relative  overflow-x-hidden ">
